...
<main id="homePage">
    ...
    <!-- <img class="text-divider2"src="img/text-divider-2.svg" alt="Text divider"> -->

    <div class="info">
        <img class="text-divider1"src="img/text-divider-1.svg" alt="Text divider">
    ...
    <aside class="seo">
        <img class="text-dividerT-B"src="img/text-divider-top.svg" alt="text divder">
        ...
        <img class="text-dividerT-B"src="img/text-divider-bottom.svg" alt="text divder">
    </aside>
